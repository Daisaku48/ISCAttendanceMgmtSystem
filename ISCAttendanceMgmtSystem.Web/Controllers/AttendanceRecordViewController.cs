...
using ISCAttendanceMgmtSystem.BL.AttendanceRecordView;
...
namespace ISCAttendanceMgmtSystem.Web.Controllers {
    ...
    /// 勤務実績確認コントローラー
    /// </summary>
    public class AttendanceRecordViewController : Controller {
        ...
        public ActionResult Index() {
            try {
                ...
                //初期化
                AttendanceRecordViewModels model = new AttendanceRecordViewModels {
                    Search = new AttendanceRecordViewModel(),
                    SearchResult = new List<AttendanceRecordViewListModel>(),
        ...
        public ActionResult SearchEx(AttendanceRecordViewModels model, string value)
        {
            try
            {
                //開始
                ...
                //表示
                return View((new AttendanceRecordViewBL(Server.MapPath(this.GetTempDir(WebConfig.GetConfigFile())))).Search(model, (LoginUser)Session["LoginUser"]));
        ...
        public ActionResult DateDownload(AttendanceRecordViewModels model) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
                ...
                //帳票出力ロジックを実行
                AttendanceRecordViewBL bl = new AttendanceRecordViewBL(fullPath);
        ...
        public ActionResult Back(AttendanceRecordViewModels model, string value) {
            try {
                //開始
                nlog.Debug(System.Reflection.MethodBase.GetCurrentMethod().Name + " start");
                //トップへ
